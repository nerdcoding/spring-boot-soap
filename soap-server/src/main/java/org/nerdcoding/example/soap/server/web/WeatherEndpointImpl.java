...
/**
 * Implementation of SOAP based web service to deliver weather information.
 */
@WebService(
        endpointInterface = "org.nerdcoding.example.soap.server.web.WeatherEndpoint",
        serviceName = "WeatherEndpoint")
